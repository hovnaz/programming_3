...
var GrassEater = require("./class_GrassEater.js");
var preadtor = require("./class_preadtor.js");
...
module.exports = class Man {
	...
	move_event(event) {
		...
		function move_man_event(e) {
			...
			// if click to arrows	
			if (e == 37) { // move to left 37, 65
				found_move = 1;
			} else if (e == 38) { // move to top
				found_move = 0;
			} else if (e == 39) { // move to  right 
				found_move = 2;
			} else if (e == 40) { // move to down
				found_move = 3;
			} else if (e == 75) {
				found_move = 4;
			}
	...
	shoot(event) {
		...
		function shoot_man_event(e) {
			...
			} else if (e == 69 && ordinary_Bullets === true) {
				if (water_Bullets === false) {
					water_Bullets = true;
					ordinary_Bullets = false;
				}
			} else if (e == 32) { // move to down
			...
			} else if (e == 49 && one_click_shoot_animals === true) {
				one_click_shoot_animals = false;
				Bullets_definitely_animals = true;

				animals_mul = 'grass';
			} else if (e == 50 && one_click_shoot_animals === true) {
				one_click_shoot_animals = false;
				Bullets_definitely_animals = true;

				animals_mul = 'grassEater';
			} else if (e == 51 && one_click_shoot_animals === true) {
				one_click_shoot_animals = false;
				Bullets_definitely_animals = true;
	...
	move(event) {
		var emptyCord_move = this.move_event(event);
		var emptyCord = this.chooseCell(emptyCord_move);
		var shoot_man = this.shoot(event);
